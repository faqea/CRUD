...
public class Buyer {
    ...
    public Buyer(int id, List<Comments> comments, List<File> files, List<Robot> robots, String name, String way, String post_index, String city, String way2, String post_index2, String city2, String phone_number, String phone_number2, String phone_number3, String email) {
        this.id = id;
