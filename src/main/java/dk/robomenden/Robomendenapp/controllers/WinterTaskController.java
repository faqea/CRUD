...
public class WinterTaskController {
    ...
    @Autowired
    public WinterTaskController(WinterTaskService winterTaskService, RobotService robotService, BuyerService buyerService, CSVGenerator csvGenerator, RoleService roleService, UserService userService) {
    ...
    public String createBuyer() {
        WinterTask winterTask = new WinterTask();
