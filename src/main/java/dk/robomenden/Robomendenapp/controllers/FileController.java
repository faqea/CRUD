...
public class FileController {
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable String fileName) throws IOException {
        ...
        Resource fileResource = new FileSystemResource("C:\\CRUD-master\\CRUD-master\\src\\main\\java\\dk\\robomenden\\Robomendenapp\\uploads" + fileName);
    ...
    public String delete(@PathVariable("id") int id, @RequestParam("fileName") String fileName,
        ...
        File file = new File("C:\\CRUD-master\\CRUD-master\\src\\main\\java\\dk\\robomenden\\Robomendenapp\\uploads" + fileName);
        file.delete();
